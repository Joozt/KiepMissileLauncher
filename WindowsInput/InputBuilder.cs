...
namespace WindowsInput
{
    ...
    internal class InputBuilder : IEnumerable<INPUT>
    {
        ...
        public InputBuilder AddMouseButtonDown(MouseButton button)
        {
            ...
            buttonDown.Data.Mouse.Flags = (UInt32)MouseButtonExtensions.ToMouseButtonDownFlag(button);
        ...
        public InputBuilder AddMouseButtonUp(MouseButton button)
        {
            ...
            buttonUp.Data.Mouse.Flags = (UInt32)MouseButtonExtensions.ToMouseButtonUpFlag(button);
